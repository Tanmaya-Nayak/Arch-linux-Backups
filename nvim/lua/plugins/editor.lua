...
return {
	...
	-- ── Rainbow Brackets ──────────────────────────────────────
	{
		...
		config = function()
			...
			-- Neon colors for brackets
			vim.api.nvim_set_hl(0, "RainbowDelimiterRed", { fg = "#FF007C" })
			vim.api.nvim_set_hl(0, "RainbowDelimiterYellow", { fg = "#FFFF00" })
			vim.api.nvim_set_hl(0, "RainbowDelimiterBlue", { fg = "#00FFFF" })
			vim.api.nvim_set_hl(0, "RainbowDelimiterOrange", { fg = "#FF8C00" })
			vim.api.nvim_set_hl(0, "RainbowDelimiterGreen", { fg = "#00FF00" })
			vim.api.nvim_set_hl(0, "RainbowDelimiterViolet", { fg = "#E040FB" })
			vim.api.nvim_set_hl(0, "RainbowDelimiterCyan", { fg = "#18FFFF" })
		end,
	},

	-- ── Indent rainbow scope ──────────────────────────────────
	{
		...
		config = function()
			...
			hooks.register(hooks.type.HIGHLIGHT_SETUP, function()
				vim.api.nvim_set_hl(0, "RainbowRed", { fg = "#FF007C" })
				vim.api.nvim_set_hl(0, "RainbowYellow", { fg = "#FFFF00" })
				vim.api.nvim_set_hl(0, "RainbowBlue", { fg = "#00FFFF" })
				vim.api.nvim_set_hl(0, "RainbowOrange", { fg = "#FF8C00" })
				vim.api.nvim_set_hl(0, "RainbowGreen", { fg = "#00FF00" })
				vim.api.nvim_set_hl(0, "RainbowViolet", { fg = "#E040FB" })
				vim.api.nvim_set_hl(0, "RainbowCyan", { fg = "#18FFFF" })
			end)
			require("ibl").setup({
