# Generated by Powerlevel10k configuration wizard on 2026-04-23 at 11:18 IST.
...
# round separators, sharp heads, round tails, 2 lines, disconnected, right frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_SUFFIX='%198F─╮'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='%198F─┤'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_SUFFIX='%198F─╯'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=198
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=200
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=198
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=55
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=166
  ...
  function my_git_formatter() {
    ...
    local       meta='%0F' # black
    local      clean='%0F' # black
    local   modified='%0F' # black
    local  untracked='%0F' # black
    local conflicted='%198F' # neon pink foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=54
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=51
